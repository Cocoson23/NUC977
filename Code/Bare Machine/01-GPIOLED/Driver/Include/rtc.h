...
* @brief    NUC970 RTC driver header file
*
* @note
...
/** @addtogroup NUC970_RTC_EXPORTED_CONSTANTS RTC Exported Constants
  @{
*/
...
typedef struct {
    ...
    PFN_RTC_CALLBACK *pfnAlarmCallBack;    /*!< Alarm ISR call back funstion */
} RTC_TIME_DATA_T;
...
/*@}*/ /* end of group NUC970_RTC_EXPORTED_CONSTANTS */
