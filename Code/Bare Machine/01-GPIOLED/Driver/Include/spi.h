...
* @version  V1.00
* $Revision: 2 $
* $Date: 15/05/18 10:44a $
* @brief    NUC970 SPI driver header file
*
* @note
...
/** @addtogroup NUC970_SPI_Driver SPI Driver
  @{
*/
...
/*@}*/ /* end of group NUC970_SPI_EXPORTED_CONSTANTS */

/** @addtogroup NUC970_SPI_EXPORTED_FUNCTIONS SPI Exported Functions
  @{
*/
...
/*@}*/ /* end of group NUC970_SPI_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NUC970_SPI_Driver */
