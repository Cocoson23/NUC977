 ...
 * $Revision: 4 $
 * $Date: 15/06/12 9:58a $
 * @brief    NUC970 FMI eMMC driver source file
 *
 * @note
...
/** @addtogroup NUC970_FMI_EMMC_Driver FMI EMMC Driver
  @{
*/


/** @addtogroup NUC970_FMI_EMMC_EXPORTED_FUNCTIONS FMI EMMC Exported Functions
  @{
*/
/// @cond HIDDEN_SYMBOLS
...
/*@}*/ /* end of group NUC970_FMI_EMMC_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NUC970_FMI_EMMC_Driver */
