...
#line 1 "D:\\Tools\\Work Tools\\Keil_v5\\ARM\\ARMCC\\Bin\\..\\include\\stdint.h"
...
#line 27 "D:\\Tools\\Work Tools\\Keil_v5\\ARM\\ARMCC\\Bin\\..\\include\\stdint.h"
...
#line 46 "D:\\Tools\\Work Tools\\Keil_v5\\ARM\\ARMCC\\Bin\\..\\include\\stdint.h"
...
#line 216 "D:\\Tools\\Work Tools\\Keil_v5\\ARM\\ARMCC\\Bin\\..\\include\\stdint.h"
...
#line 241 "D:\\Tools\\Work Tools\\Keil_v5\\ARM\\ARMCC\\Bin\\..\\include\\stdint.h"
...
#line 305 "D:\\Tools\\Work Tools\\Keil_v5\\ARM\\ARMCC\\Bin\\..\\include\\stdint.h"
...
#line 92 "..\\..\\Driver\\Include\\nuc970.h"

 
#line 131 "..\\..\\Driver\\Include\\nuc970.h"
...
#line 271 "..\\..\\Driver\\Include\\nuc970.h"

#line 306 "..\\..\\Driver\\Include\\nuc970.h"
...
#line 369 "..\\..\\Driver\\Include\\nuc970.h"



 
#line 397 "..\\..\\Driver\\Include\\nuc970.h"
...
#line 430 "..\\..\\Driver\\Include\\nuc970.h"

#line 441 "..\\..\\Driver\\Include\\nuc970.h"

#line 452 "..\\..\\Driver\\Include\\nuc970.h"

#line 463 "..\\..\\Driver\\Include\\nuc970.h"

#line 474 "..\\..\\Driver\\Include\\nuc970.h"

#line 485 "..\\..\\Driver\\Include\\nuc970.h"

#line 496 "..\\..\\Driver\\Include\\nuc970.h"

#line 507 "..\\..\\Driver\\Include\\nuc970.h"

#line 518 "..\\..\\Driver\\Include\\nuc970.h"

#line 529 "..\\..\\Driver\\Include\\nuc970.h"

#line 540 "..\\..\\Driver\\Include\\nuc970.h"

#line 551 "..\\..\\Driver\\Include\\nuc970.h"

#line 564 "..\\..\\Driver\\Include\\nuc970.h"
...
#line 706 "..\\..\\Driver\\Include\\nuc970.h"

 
#line 723 "..\\..\\Driver\\Include\\nuc970.h"

 
#line 737 "..\\..\\Driver\\Include\\nuc970.h"

 
#line 745 "..\\..\\Driver\\Include\\nuc970.h"
...
#line 806 "..\\..\\Driver\\Include\\nuc970.h"

 
#line 814 "..\\..\\Driver\\Include\\nuc970.h"

 
#line 880 "..\\..\\Driver\\Include\\nuc970.h"

 
#line 930 "..\\..\\Driver\\Include\\nuc970.h"

 
#line 954 "..\\..\\Driver\\Include\\nuc970.h"
...
#line 1005 "..\\..\\Driver\\Include\\nuc970.h"



 
#line 1025 "..\\..\\Driver\\Include\\nuc970.h"



 
#line 1045 "..\\..\\Driver\\Include\\nuc970.h"




 
#line 1066 "..\\..\\Driver\\Include\\nuc970.h"



 
#line 1086 "..\\..\\Driver\\Include\\nuc970.h"



 
#line 1106 "..\\..\\Driver\\Include\\nuc970.h"



 
#line 1126 "..\\..\\Driver\\Include\\nuc970.h"



 
#line 1146 "..\\..\\Driver\\Include\\nuc970.h"
...
#line 1234 "..\\..\\Driver\\Include\\nuc970.h"

#line 1242 "..\\..\\Driver\\Include\\nuc970.h"

#line 1250 "..\\..\\Driver\\Include\\nuc970.h"

#line 1258 "..\\..\\Driver\\Include\\nuc970.h"
...
#line 1391 "..\\..\\Driver\\Include\\nuc970.h"

#line 1404 "..\\..\\Driver\\Include\\nuc970.h"

#line 1417 "..\\..\\Driver\\Include\\nuc970.h"

#line 1430 "..\\..\\Driver\\Include\\nuc970.h"

#line 1443 "..\\..\\Driver\\Include\\nuc970.h"

#line 1456 "..\\..\\Driver\\Include\\nuc970.h"

#line 1469 "..\\..\\Driver\\Include\\nuc970.h"

#line 1482 "..\\..\\Driver\\Include\\nuc970.h"

#line 1495 "..\\..\\Driver\\Include\\nuc970.h"

#line 1508 "..\\..\\Driver\\Include\\nuc970.h"
...
#line 1567 "..\\..\\Driver\\Include\\nuc970.h"

#line 1574 "..\\..\\Driver\\Include\\nuc970.h"
...
#line 1595 "..\\..\\Driver\\Include\\nuc970.h"

#line 1607 "..\\..\\Driver\\Include\\nuc970.h"
...
#line 1794 "..\\..\\Driver\\Include\\nuc970.h"

#line 1834 "..\\..\\Driver\\Include\\nuc970.h"
...
BOOL volatile _sys_bIsAICInitial = (0);
...
sys_pvFunPtr sysIrqHandlerTable[] = { 0,                 
                                      SYS_Interrupt_Shell,    
                                      SYS_Interrupt_Shell,    
                                      SYS_Interrupt_Shell,    
                                      SYS_Interrupt_Shell,    
...
__irq void sysIrqHandler()
{
    ...
    _mIPER = ((*((volatile unsigned int *)((0xB8002000+0x118)))) >> 2) & 0x3f;
    _mISNR = (*((volatile unsigned int *)((0xB8002000+0x120))));
    if (_mISNR != 0)
        if (_mIPER == _mISNR)
...
{
    sysprintf("ISR not found! ISNR=%d\n", (*((volatile unsigned int *)((0xB8002000+0x120)))));
}
...
INT32 sysDisableInterrupt(IRQn_Type eIntNo)
{
    if ((eIntNo > 62) || (eIntNo < 1))
        return 1;

    if (eIntNo < 32)
        *((volatile unsigned int *)((0xB8002000+0x138))) = (1 << eIntNo);
    else
        *((volatile unsigned int *)((0xB8002000+0x13C))) = (1 << (eIntNo - 32));
...
INT32 sysEnableInterrupt(IRQn_Type eIntNo)
{
    ...
    if (eIntNo < 32)
        *((volatile unsigned int *)((0xB8002000+0x130))) = (1 << eIntNo);
    else
        *((volatile unsigned int *)((0xB8002000+0x134))) = (1 << (eIntNo - 32));
...
PVOID sysInstallISR(INT32 nIntTypeLevel, IRQn_Type eIntNo, PVOID pvNewISR)
{
    ...
    _mRegAddr = (0xB8002000+0x00) + ((eIntNo / 4) * 4);
    shift = (eIntNo % 4) * 8;
    nIntTypeLevel &= 0xff;
    *((volatile unsigned int *)(_mRegAddr)) = ((*((volatile unsigned int *)(_mRegAddr))) & ~(0x07 << shift)) | (nIntTypeLevel << shift);

    if ((nIntTypeLevel & 0x7) == 0) {
...
INT32 sysSetGlobalInterrupt(INT32 nIntState)
{
    switch (nIntState) {
    case 0:
        *((volatile unsigned int *)((0xB8002000+0x130))) = 0xFFFFFFFF;
        *((volatile unsigned int *)((0xB8002000+0x134))) = 0xFFFFFFFF;
        break;
...
INT32 sysSetInterruptPriorityLevel(IRQn_Type eIntNo, UINT32 uIntLevel)
{
    ...
    shift = (eIntNo % 4) * 8;
    uIntLevel &= 0x7;
    *((volatile unsigned int *)(_mRegAddr)) = ((*((volatile unsigned int *)(_mRegAddr))) & ~(0x07 << shift)) | (uIntLevel << shift);
...
INT32 sysSetInterruptType(IRQn_Type eIntNo, UINT32 uIntSourceType)
{
    ...
    shift = (eIntNo % 4) * 8;
    uIntSourceType &= 0xC0;
    *((volatile unsigned int *)(_mRegAddr)) = ((*((volatile unsigned int *)(_mRegAddr))) & ~(0xC0 << shift)) | (uIntSourceType << shift);
...
UINT32  sysGetInterruptEnableStatus(void)
{
    return ((*((volatile unsigned int *)((0xB8002000+0x128)))));
}


UINT32  sysGetInterruptEnableStatusH(void)
{
    return ((*((volatile unsigned int *)((0xB8002000+0x12C)))));
}
...
INT32 sysGetPLL(UINT32 reg)
{
    ...
    N =(((*((volatile unsigned int *)(reg))) & 0x007F)>>0)+1;
    M =(((*((volatile unsigned int *)(reg))) & 0x1F80)>>7)+1;
    P =(((*((volatile unsigned int *)(reg))) & 0xE000)>>13)+1;
...
UINT32 sysGetClock(CLK_Type clk)
{
    ...
    switch(clk) {
    case SYS_UPLL:
            return sysGetPLL((0xB0000200+0x64));

    case SYS_APLL:
            return sysGetPLL((0xB0000200+0x60));

    case SYS_SYSTEM: {
            reg = (*((volatile unsigned int *)((0xB0000200+0x20))));
        switch (reg & 0x18) {
    case 0x0:
            src = 12;    
        break;
    case 0x10:
            src = sysGetPLL((0xB0000200+0x60));
            break;
        case 0x18:
                src = sysGetPLL((0xB0000200+0x64));
            break;
        default:
                return 0;
        }
